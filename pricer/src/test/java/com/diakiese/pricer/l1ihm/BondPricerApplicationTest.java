...
import com.diakiese.pricer.l2servicelayer.ratecurve.TestExcelRateCurveBuilderImpl;
...
public class BondPricerApplicationTest extends Application {
	...
	@Override public void start(Stage stage) throws IOException {
    	...
    	BondPricerTauxFixeImpl bondTauxFixePricer = new BondPricerTauxFixeImpl(new TestExcelRateCurveBuilderImpl(),new LinearInterpolator());
